...
// Modify the index_existing_pdfs function to be more resource-friendly
function index_existing_pdfs() {
    ...
    $args = array(
        'post_type' => 'attachment',
        'post_mime_type' => 'application/pdf',
        'posts_per_page' => 2, // REDUCED: Process only 2 PDFs at a time instead of 5
        'post_status' => 'inherit',
        'meta_query' => array(
            'relation' => 'OR',
            array(
...
function pdf_search_indexer_settings_html() {
    ...
    <div class="wrap">
        ...
        <div style="margin-top: 20px;">
            ...
            <p>The next batch will start at: <strong><?php echo esc_html(date('H:i:s', $next_scheduled)); ?></strong></p>
            <?php endif; ?>
        </div>
    </div>
    <?php
