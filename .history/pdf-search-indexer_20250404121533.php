...
function pdf_search_indexer_settings_html() {
    ...
    if (isset($_POST['pdf_search_indexer_reindex']) && check_admin_referer('pdf_search_indexer_reindex_nonce')) {
        ...
        echo '<div class="notice notice-success"><p>PDF reindexing has been initiated in the background. This process will continue automatically and may take some time to complete.</p></div>';
    }
    ...
    if (isset($_POST['pdf_search_indexer_stop']) && check_admin_referer('pdf_search_indexer_stop_nonce')) {
        ...
        echo '<div class="notice notice-success"><p>PDF indexing has been stopped. Any PDFs that were being processed have been reset to pending status.</p></div>';
    }
    ...
    $processing_pdfs = count(get_posts($args));
    ...
    <div class="wrap">
        ...
        <p>Currently Processing: <?php echo $processing_pdfs; ?></p>
